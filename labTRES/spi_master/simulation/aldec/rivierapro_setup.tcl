...
# ACDS 20.1 711 win32 2024.09.30.16:05:37
# ----------------------------------------
...
# ----------------------------------------
# If spi_master is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/spi_master.v"
}
