...
# ACDS 20.1 711 win32 2024.09.30.20:29:45
# ----------------------------------------
...
# ----------------------------------------
# If desclk16Mhz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "desclk16Mhz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/desclk16Mhz.vo"
}
